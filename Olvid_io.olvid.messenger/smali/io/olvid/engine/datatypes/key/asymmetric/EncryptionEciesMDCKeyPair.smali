.class public Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;
.super Lio/olvid/engine/datatypes/key/asymmetric/KeyPair;
.source "EncryptionEciesMDCKeyPair.java"


# direct methods
.method public constructor <init>(Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;)V
    .locals 0
...
.method public static generate(Lio/olvid/engine/crypto/PRNGService;)Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;
    .locals 7
    ...
    .line 46
    new-instance p0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;

    new-instance v0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;

    invoke-direct {v0, v2}, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;-><init>(Ljava/util/HashMap;)V

    new-instance v1, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;

    invoke-direct {v1, v3}, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;-><init>(Ljava/util/HashMap;)V

    invoke-direct {p0, v0, v1}, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;-><init>(Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;)V
...
# virtual methods
.method public getPrivateKey()Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;
    .locals 1

    .line 23
    iget-object v0, p0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;->privateKey:Lio/olvid/engine/datatypes/key/asymmetric/PrivateKey;

    check-cast v0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;
...
.method public bridge synthetic getPrivateKey()Lio/olvid/engine/datatypes/key/asymmetric/PrivateKey;
    ...
    .line 15
    invoke-virtual {p0}, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;->getPrivateKey()Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPrivateKey;
...
.method public getPublicKey()Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;
    .locals 1

    .line 18
    iget-object v0, p0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;->publicKey:Lio/olvid/engine/datatypes/key/asymmetric/PublicKey;

    check-cast v0, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;
...
.method public bridge synthetic getPublicKey()Lio/olvid/engine/datatypes/key/asymmetric/PublicKey;
    ...
    .line 15
    invoke-virtual {p0}, Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCKeyPair;->getPublicKey()Lio/olvid/engine/datatypes/key/asymmetric/EncryptionEciesMDCPublicKey;
